...
set_property PACKAGE_PIN U9 [get_ports {swi0}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {swi0}]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
set_property PACKAGE_PIN U8 [get_ports {swi1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {swi1}]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
set_property PACKAGE_PIN R7 [get_ports {swi2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {swi2}]
...
set_property PACKAGE_PIN P4 [get_ports rstn_i]					
...
set_property PACKAGE_PIN K5 [get_ports pwm1_red_o]					
	set_property IOSTANDARD LVCMOS33 [get_ports pwm1_red_o]
##Bank = 15, Pin name = IO_L5P_T0_AD9P_15,					Sch name = LED16_G
set_property PACKAGE_PIN F13 [get_ports pwm1_green_o]				
	set_property IOSTANDARD LVCMOS33 [get_ports pwm1_green_o]
##Bank = 35, Pin name = IO_L19N_T3_VREF_35,					Sch name = LED16_B
set_property PACKAGE_PIN F6 [get_ports pwm1_blue_o]					
	set_property IOSTANDARD LVCMOS33 [get_ports pwm1_blue_o]
...
##set_property PACKAGE_PIN L3 [get_ports {Sept_segment[0]}]					
	##set_property IOSTANDARD LVCMOS33 [get_ports {Sept_segment[0]}]
##Bank = 34, Pin name = IO_L3N_T0_DQS_34,					Sch name = CB
##set_property PACKAGE_PIN N1 [get_ports {Sept_segment[1]}]					
	##set_property IOSTANDARD LVCMOS33 [get_ports {Sept_segment[1]}]
##Bank = 34, Pin name = IO_L6N_T0_VREF_34,					Sch name = CC
##set_property PACKAGE_PIN L5 [get_ports {Sept_segment[2]}]					
	##set_property IOSTANDARD LVCMOS33 [get_ports {Sept_segment[2]}]
##Bank = 34, Pin name = IO_L5N_T0_34,						Sch name = CD
##set_property PACKAGE_PIN L4 [get_ports {Sept_segment[3]}]					
	##set_property IOSTANDARD LVCMOS33 [get_ports {Sept_segment[3]}]
##Bank = 34, Pin name = IO_L2P_T0_34,						Sch name = CE
##set_property PACKAGE_PIN K3 [get_ports {Sept_segment[4]}]					
	##set_property IOSTANDARD LVCMOS33 [get_ports {Sept_segment[4]}]
##Bank = 34, Pin name = IO_L4N_T0_34,						Sch name = CF
##set_property PACKAGE_PIN M2 [get_ports {Sept_segment[5]}]					
	##set_property IOSTANDARD LVCMOS33 [get_ports {Sept_segment[5]}]
##Bank = 34, Pin name = IO_L6P_T0_34,						Sch name = CG
##set_property PACKAGE_PIN L6 [get_ports {Sept_segment[6]}]					
	##set_property IOSTANDARD LVCMOS33 [get_ports {Sept_segment[6]}]
...
##set_property PACKAGE_PIN G13 [get_ports {odata}]					
	##set_property IOSTANDARD LVCMOS33 [get_ports {odata}]
...
##set_property PACKAGE_PIN A11 [get_ports odata]					
	##set_property IOSTANDARD LVCMOS33 [get_ports odata]
##Bank = 15, Pin name = IO_L6P_T0_15,						Sch name = AUD_SD
##set_property PACKAGE_PIN D12 [get_ports un]						
	##set_property IOSTANDARD LVCMOS33 [get_ports un]
